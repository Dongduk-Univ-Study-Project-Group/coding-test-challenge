...
- 해당 폴더 안에 [README.md](http://README.md) 파일을 추가해주세요.
...
- 내가 푼 문제는 폴더별로 분류하신 후, [README.md](http://README.md) 파일에 내가 푼 문제에 대한 설명 및 해석 같이 본인만의 풀이를 적어주시고, Solution.확장자 파일을 만드신 후 내 코드를 복사 및 붙여넣기 하시면 됩니다.
    - 확장자는 언어마다 다를 수 있습니다.
